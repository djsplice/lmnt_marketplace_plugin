#!/bin/bash
# Script to fix import path issues in the LMNT Marketplace Plugin

set -e

echo "LMNT Marketplace Plugin Import Path Fix"
echo "======================================"
...
# Update lmnt_marketplace_plugin.py to use relative imports
echo "Updating lmnt_marketplace_plugin.py to use relative imports..."
...
class LmntMarketplacePlugin:
    ...
    def __init__(self, config):
        ...
        try:
            # Use relative import - this is the key change
            ...
            logging.info("Successfully imported LmntMarketplaceIntegration")
